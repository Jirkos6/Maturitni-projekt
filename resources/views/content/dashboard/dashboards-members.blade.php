        ...
        <div class="container py-5">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card shadow-sm rounded-3">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                <p><strong>Velikost trička:</strong>
                                    {{ $data->size ? '' . $data->size : '' }}</p>
                            </div>

                            <div class="mb-3">
                                <h5 class="text-muted">Kontakt na matku</h5>
                                <p><strong>Jméno:</strong> {{ $data->mother_name ?? '' }}
                                    {{ $data->mother_surname ?? '' }}</p>
                            ...
                            <div class="mb-3">
                                ...
                                <p><strong>Jméno:</strong> {{ $data->father_name ?? '' }}
                                    {{ $data->father_surname ?? '' }}</p>
            ...
            @if (null !== $achievements->count())
                <div class="col-12 mt-5">
                    <h3 class="text-center mb-4">Odborky ({{ $achievements->count() }})
                    </h3>
                    <div class="row">
                            ...
                            <div class="col-md-2 col-sm-4 col-6 mb-4">
                                <div class="card shadow-sm rounded-3">
                                    ...
                                    <div class="card-body p-3">
                                        ...
                                        @if (null !== $achievement->achieved_at)
