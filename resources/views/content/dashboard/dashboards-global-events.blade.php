                ...
                <div class="card shadow-sm border-0">
                    <div class="card-header bg-transparent py-3">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="btn-group">
                                <button type="button" class="btn btn-outline-primary" id="attendance-view-toggle-btn"
                                    onclick="toggleAttendanceView()">
                                    <i class="ri-table-line me-1"></i> Přepnout zobrazení
                                </button>
                                <button class="btn btn-outline-primary dropdown-toggle" type="button"
                                    id="attendanceFilterDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                                    <i class="ri-filter-line me-1"></i> Filtrovat
                                </button>
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="attendanceFilterDropdown">
                                    <li><a class="dropdown-item" href="#" onclick="filterAttendance('all')">Všechny
                                            akce</a></li>
                                    <li><a class="dropdown-item" href="#"
                                    ...
                                    @foreach ($events as $event)
                                        <div class="card-body border-bottom attendance-event-item"
                                            ...
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="d-flex align-items-center" title="Celkem účastníků">
                                                            <span
                                                        ...
                                                        <div class="d-flex align-items-center" title="Potvrzeno rodiči">
                                                            <span
                                                        ...
                                                        <div class="attendance-status-wrapper">
                                                            <div class="d-flex flex-column gap-1">
                                                                <select
                                                                    ...
                                                                    @php
                                                                        $status = isset(
                                                                            $attendanceData[$event->id][$member->id],
                                                                        )
                                                                            ? $attendanceData[$event->id][
                                                                                $member->id
                                                                            ][0]->status
    ...
    @if (Teams::count() >= 2)
        ...
        @else
            <div class="text-center py-5">
                ...
                <p class="text-muted mb-4">Zatím nejsou naplánovány žádné akce pro více týmů. Přidejte
                    novou akci pomocí
                    tlačítka níže.</p>
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#eventModal">
                    <i class="ri-add-line me-1"></i> Přidat akci
