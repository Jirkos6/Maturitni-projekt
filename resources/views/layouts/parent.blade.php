            ...
            <ul class="space-y-2 font-medium">
                <li>
                    <a href="/dashboard"
                        ...
                        <span class="ms-3">Hlavní panel</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="/dashboard/members/attendance/{{ $members->id }}"
                        ...
                        <span
                            class="inline-flex items-center justify-center w-3 h-3 p-4 ms-3 text-sm font-medium text-blue-800 bg-blue-100 rounded-full dark:bg-blue-900 dark:text-blue-300">{{ $attendancepercentage }}%</span>
                    </a>
                </li>
                <li>
                    <a href="/dashboard/members/achievements/{{ $members->id }}"
                        ...
                        <svg class="shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white xmlns="http://www.w3.org/2000/svg"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Odborky</span>
                        <span
                            class="inline-flex items-center justify-center w-3 h-3 p-3 ms-3 text-sm font-medium text-blue-800 bg-blue-100 rounded-full dark:bg-blue-900 dark:text-blue-300">{{ count($achievements) }}</span>
                    </a>
                </li>
                <li>
                    <a href="/dashboard/members/calendar/{{ $members->id }}"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Kalendář akcí</span>
                        <span
                            class="inline-flex items-center justify-center w-3 h-3 p-3 ms-3 text-sm font-medium text-blue-800 bg-blue-100 rounded-full dark:bg-blue-900 dark:text-blue-300">{{ $upcomingeventcount }}</span>
                    </a>
                </li>
            </ul>
        </div>
