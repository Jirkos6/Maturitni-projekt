<x-action-section>
    ...
    <x-slot name="content">
        ...
        <x-dialog-modal wire:model.live="confirmingUserDeletion">
            ...
            <x-slot name="content">
                {{ __('Opravdu chcete smazat svůj účet? Jakmile bude váš účet smazán, všechny jeho zdroje a data budou trvale odstraněny. Prosím, zadejte své heslo, abyste potvrdili, že chcete svůj účet trvale smazat.') }}
